...
const Header = () => {
  return (
    <div className='mt-24 lg:mt-40 w-11/12 max-w-3xl text-center mx-auto flex flex-col items-center justify-center gap-4'>
      <motion.div
        initial={{scale:0}}
        whileInView={{scale:1}}
        transition={{duration:0.8, type:'spring', stitchTiles:100}}
      >
      ...
      <motion.h3 
        ...
        transition={{duration:0.8, type:'spring', stitchTiles:100}}
        className='flex items-end gap-2 text-ml md:text-2xl mb-3 font-Ovo'>
        Hi! I'm Do Tien Luong{' '}
      ...
      <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
        ...
        <motion.a
          ...
          href='/CV_Do_Tien_Luong_Fullstack_Intern.pdf'
          download

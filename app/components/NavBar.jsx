...
const NavBar = ({ isDarkMode, setIsDarkMode }) => {
  ...
  return (
    <>
      ...
      <nav
        className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 ${isScroll ? 'bg-opacity-50 backdrop-blur-lg shadow-sm dark:bg-darkTheme dark:shadow-white/20' : ''}`}>
        <a href='#top'> 
          <Image
            src={assets.logo}
            className='w-14 lg:w-28 cursor-pointer mr-14'
            alt='logo'
          />
        </a>
        <ul
        ...
        <div className='flex items-center gap-4'>
          ...
          >
            Contact
            <Image src={isDarkMode? assets.arrow_icon_dark:assets.arrow_icon} className='w-3' alt='logo_contact' />
          </a>
